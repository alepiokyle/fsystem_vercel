...
<head>
    ...
    <title>{{ config('app.name', 'eGrade Connect') }} - Teacher Dashboard</title>
    ...
    <body>
        ...
        <nav class="pc-sidebar">
            <div class="navbar-wrapper">
                <div class="m-header">
                    <a href="{{ route('teacher.teacherdashboard') }}" class="b-brand text-primary egc-brand">
...
<script>
    ...
    function switchRole() {
        Swal.fire({
            ...
            html: "<p style='font-size:14px; color:#4b5563;'>Are you sure you want to switch your role? You are currently logged in as Teacher. Switching roles will redirect you to the Dean Dashboard.</p>",
            icon: "question",
            showCancelButton: true,
            ...
            if (result.isConfirmed) {
                window.location.href = "{{ route('teacher.switch-role') }}";
            }
        });
    }
</script>
